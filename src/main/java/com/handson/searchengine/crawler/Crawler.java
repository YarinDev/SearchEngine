...
public class Crawler {
    ...
    // initCrawlInRedis initializes the crawl status in Redis
    ...
    //setCrawlStatus updates the crawl status in Redis through the algorithm
    ...
    //crawlHasVisited checks if the URL has been visited by the crawler, if url exists in Redis, it returns true, otherwise it returns false and increments the count of visited URLs to Redis
    ...
    // getVisitedUrls returns the number of visited URLs from Redis
    ...
    //getCrawlInfo returns the crawl status from Redis
